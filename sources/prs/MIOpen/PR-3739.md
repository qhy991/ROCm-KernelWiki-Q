...
description: This PR removes CK's gemm and reduction libraries from MIOpen.  This
  change is a step towards moving to CK header-only libraries, and should also allow
  MIOpen's
---
