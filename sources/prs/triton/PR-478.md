...
description: Reduce the tolerance used to checking correctness. Previous big difference
  is mainly caused by the format `fp8e4m3b8`, which introduced big rounding error
  in co
---
