...
repo: ROCm/triton
pr: 891
title: '[AMD] Use v_dot for bf16 multiplication on gfx11/gfx12 (triton-lang#8444)'
author: ptrojahn
date: '2025-10-21'
url: https://github.com/ROCm/triton/pull/891
...
description: RDNA does not support bf16 multiplication, so we currently upcast to
  fp32, multiply and downcast to bf16 again. We can avoid the expensive downcasting
  step by u
---

# [AMD] Use v_dot for bf16 multiplication on gfx11/gfx12 (triton-lang#8444)

Merged PR #891 in [ROCm/triton](https://github.com/ROCm/triton/pull/891).
...
- [PR #891](https://github.com/ROCm/triton/pull/891)
