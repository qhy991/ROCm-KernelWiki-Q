...
- ck-tile-programming
- vectorized-load
description: This PR fixes a bug of inconsistent behavior of `FixedVectorSize` parameter
  inside CK Tile Convolutions and was discovered while porting convolution instances
  f
---
