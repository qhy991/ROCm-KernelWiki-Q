...
hardware_features:
- block-scale
description: In `example/ck_tile/38_block_scale_gemm` for quant_mode=aquant the current
  memory pipeline only supports one scheduling mechanism (intrawave) where each wave
  wo
---
