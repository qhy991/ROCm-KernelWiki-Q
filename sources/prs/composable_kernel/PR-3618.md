...
techniques:
- ck-tile-programming
description: '**NOTE**: Targetting https://github.com/ROCm/composable_kernel/pull/3604,
  merge that one first and **update the target branch** (GitHub should implement proper '
---
