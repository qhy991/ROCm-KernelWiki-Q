...
description: The original Gluon `gemm_afp4wfp4` kernel suffered from an inferior performance
  compared to the brother Triton kernel and was around 14% slower (considering a p
---

# [gluon gemm_afp4wfp4] Fix data access pattern to remove redundant data loads

Opened PR #3355 in [ROCm/aiter](https://github.com/ROCm/aiter/pull/3355).
